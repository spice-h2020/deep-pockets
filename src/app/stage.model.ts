...
export class statementStage extends Stage {
    ...
    constructor (
        ...
        public position?: number,
        public title: string = "",
        public body: string = "Statement goes here / Mae'r datganiad yn mynd yma",
...
export class questionStage extends Stage {
    ...
    constructor (
        ...
        public id?: number,
        public position?: number,
        public title: string = "Question / Cwestiwn",
        public body: string = "Question goes here / Mae'r cwestiwn yn mynd yma",
        public question: Question = {type: "question", title: "Question goes here / Mae'r cwestiwn yn mynd yma", choice: false, multiselect: false, options: []},
        public help?: string,
...
export class storyStage extends Stage {
    ...
    constructor (
        ...
        public id?: number,
        public position?: number,
        public title: string = "Story / Stori",
        public body: string = "Story stem goes here / Mae coesyn y stori yn mynd yma",
        public help: string = "Please read and complete the following story / Darllenwch a chwblhewch y stori ganlynol os gwelwch yn dda",
...
export class multiquestionStage extends Stage {
    ...
    constructor (
        ...
        public id?: number,
        public position?: number,
        public title: string = "Questions / Cwestiynau",
        public body: Array<string> = ["First question goes here / Mae'r cwestiwn cyntaf yn mynd yma","Second question goes here / Mae'r ail gwestiwn yn mynd yma"],
        public questions: Array<Question> = [{type: "question", title: "First question goes here / Mae'r cwestiwn cyntaf yn mynd yma", choice: false, multiselect: false, options: []},
        {type: "question", title: "Second question goes here / Mae'r ail gwestiwn yn mynd yma", choice: false, multiselect: false, options: []}],
        public help: string = "Try as many of the following questions as you like / Rhowch gynnig ar gynifer o'r cwestiynau canlynol ag y dymunwch",
